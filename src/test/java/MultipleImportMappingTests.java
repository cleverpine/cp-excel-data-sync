...
public class MultipleImportMappingTests extends ImportTests {
    ...
    void setup() {
        ...
        ExcelMultipleImportConfig multipleConfig =
                new ExcelMultipleImportConfig(List.of(new ExcelSheetImportConfig<>(ValueTypeTestDto.class, config, testDtoList::addAll)));
